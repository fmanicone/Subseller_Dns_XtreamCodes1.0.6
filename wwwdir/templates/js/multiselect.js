...
$.ajax({
    ...
    success: function(data){
        if (data.isreseller==true){
	$(".icn_acc").parent().append("<h3>Reseller</h3><ul class=\"toggle\"><li class=\"icn_add_user\"><a href=\"add_reseller.php\">Create New Reseller</a></li><li class=\"icn_acc\"><a href=\"reseller.php\">Manage Reseller</a></li></ul>");
	}
	dns=data.dns;
    ...
    jQuery.ajaxSetup({
		...
		if (data.indexOf('name="list" id="list"') >= 0){
        		var data= data.replace(new RegExp(dnsserver, 'g'), dns);
		}  
  	return data;        
        }
    });
